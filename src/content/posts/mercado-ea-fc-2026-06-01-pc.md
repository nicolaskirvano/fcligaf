...
pubDatetime: 2026-06-02T01:07:02.000Z
title: "Liga F no EA FC em 01/06: altas e baixas — PC"
draft: false
featured: true
tags:
  - mercado
  ...
  - altas-e-baixas
  - pc
description: "Snapshot histórico de 01/06/2026 no PC: Nerea Nevado liderou as altas e Estefanía Banini as baixas em Liga F. Compare preços, variações, gráfico e riscos."
---
...
Nas 18 cartas destacadas nas tabelas, **Nerea Nevado** registrou o maior movimento de 24h (+41,2%), enquanto **Estefanía Banini** marcou o menor (-25,8%). A distância entre os extremos foi de **67,0 pontos percentuais**.

A mediana de 24h do recorte ficou em **-5,5%**: 8 destaques subiam e 10 caíam. Essa dispersão ajuda a comparar o dia, mas não transforma o snapshot antigo em preço ou sinal atual.

![Gráfico de variação em 24h para os destaques de Liga F no EA FC em 01/06: altas e baixas — PC](/charts/mercado-ea-fc-2026-06-01-pc.svg)
...
- **Aitana Bonmatí (97)** subiu **+20%** em 24h, a **3M coins** (faixa do dia: 2.47M–4M). Está +14% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.

- **Irene Paredes (88)** subiu **+19.5%** em 24h, a **23k coins** (faixa do dia: 19k–23k). Está em linha com a média de 7 dias (-4%). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
- **Estefanía Banini (89)** caiu **-25.8%** em 24h, a **23k coins** (faixa do dia: 21k–31k). Está em linha com a média de 7 dias (+2%). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
- **Alexia Putellas (92)** caiu **-24.1%** em 24h, a **488k coins** (faixa do dia: 400k–643k). Está -14% abaixo da média de 7 dias (descontada). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
Naquele dia, o mercado estava em alta — predominam as valorizações, com 17 cartas em alta contra 36 em queda (média 17.72%).
...
- [Liga F baratos no EA FC em 01/06 — PC](/posts/jogadores-baratos-ea-fc-2026-06-01-pc/)
