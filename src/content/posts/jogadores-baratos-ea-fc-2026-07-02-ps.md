...
title: "Liga F baratos no EA FC em 02/07 — PS"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - ps
description: "Em 02/07/2026 no PS, Mapi León liderou a seleção de Liga F por 2.000 coins. Compare 8 cartas, OVR, preço, 7d e gráfico."
---
...
Entre 8 opções, **Mapi León** tinha o menor preço (2.000 coins). O maior OVR era de **Mapi León** (89), por 2.000 coins.

O preço mediano do recorte foi **13.500 coins** e 8 cartas vinham de queda em 7d. Todas estavam estritamente abaixo de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Liga F baratos no EA FC em 02/07 — PS](/charts/jogadores-baratos-ea-fc-2026-07-02-ps.svg)
...
- **Caroline Weir (89, CAM)** da Liga F, a apenas **14k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.

- **Rocío Gálvez (88, CB)** da Liga F, a apenas **14k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.

- **Allegra Poljak (87, RB)** da Liga F, a apenas **14k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.
